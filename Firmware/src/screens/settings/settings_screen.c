...
void settings_screen_create(void)
{
    ...
    bindings.on_nav_home      = settings_presenter_on_nav_home;
    bindings.on_nav_eit       = settings_presenter_on_nav_eit;
    bindings.on_nav_settings  = settings_presenter_on_nav_settings;
    ...
    bindings.on_send_exam        = settings_presenter_on_send_exam;
